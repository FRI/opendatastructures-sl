...
\section{Vmesniki}
\seclabel{interfaces}
Ko govorimo o podatkovnih strukturah, se moramo zavedati razlike med vmesnikom podatkovne strukture in njegovo implementacijo. Vmesnik opisuje kaj podatkovna struktura počne, medtem ko implementacija opisuje, kako to počne.
