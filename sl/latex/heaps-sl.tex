...
#Queue# s prednostjo. Obe od teh dveh struktur sta posebne oblike dvojiškega drevesa imenovani \emph{Kopica}, 
\index{Kopica}%
...
Če uporabimo Eytzingerjevo metodo na dovolj velikih drevesih se začnejo pojavljati vzorci.
...
o-mo-go-ča, da je najmanjša vrednost #Queue# s prednostjo tako na shranjena na poziciji 0 (koren).
...
Implementacija #remove()# operacije, katera odstrani najmanjšo vrednost
...
od višine (implicitnega) binarnega drevesa. Na srečo je to \emph{polno}
