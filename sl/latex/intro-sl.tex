...
V tej knjigi bomo analizirali teoretično časovno zahtevnost operacij na podatovnih strukturah, ki smo se jih učili. Da bi to natančneje preučili, potrebujemo matematični model računanja. Uporabljali bomo \emph{#w#-bit
word-RAM}
\index{word-RAM}%
\index{RAM}%
