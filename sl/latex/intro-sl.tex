...
V resnici gre za poenostavljene vrezije #List#, #Set#, #Map#,
...
ki vsebuje asimptotično notacijo, logaritme, fakultete, 
Stirlingovo aproksimacijo, osnove verjetnosti in vse ostalo, vzemi v 
roko učbenik Lyman, Leighton in Meyer \cite{llm11}. Za osnove matematične analize, 
...
Več o osnovah verjetnosti, predvsem področja, ki je tesno povezana z računalništvom, 
...
\begin{exc}
  ...
  \item Preberi vhod vrstico po vrstico in izpiši vrstice v
    	obratnem vrstnem redu tako, da bo zadnji vnos zdaj izpisan prvi,
	...
	\item Preberi prvih 50 vrstic vhoda in jih nato izpiši v obratnem
		...
		obratnem vrstnem redu. Slednje ponavljaj, dokler vrstic vhoda ne zmanjka.
		...
		Tekom izvajanja naj program ne hrani več kot 50 vrstic naenkrat.
	...
	\item Beri vhod vrstico po vrstico. Program bere po 42 vrstic in če
		...
		potem naj izpiše 200. vrstico. Program naj bo implementiran tako, da
	...
	\item Beri vhod vrstico po vrstico in na izhod izpiši le tiste, ki so
		se na vhodu pojavile prvič. Bodi posebno pozoren na to, da datoteka
		na vhodu, ki ima veliko podvojenih vrstic, ne porabi več pomnilnika,
		kot ga je potrebnega za zapis števila unikatnih vrstic. 	
	
	\item Beri vhod vrstico po vrstico in izpiši vse vrstice, ki so se
		vsaj enkrat že pojavile na vhodu (cilj programa je, da se izločijo
		unikatne vrstice vhoda). Bodi pozoren na to, da datoteka z veliko
		podvojenimi vrsticami na vhodu ne porabi več pomnilnika, kot ga je
		potrebnega za zapis števila unikatnih vrstic. 
  \end{enumerate}
\end{exc} 
