...
\index{blok}%
diska. Vsak izmed diskov vezanih na računalnik ima velikost bloka 4\,096; vsakič, ko preberemo en bajt, nam disk vrne blok, ki vsebuje 4\,096 bajtov. Če našo podatkovno strukturo skrbno organiziramo, to pomeni, da z vsakim dostopom do diska dobimo 4\,096 bajtov, ki so nam v pomoč pri dokončanju operacije.
...
\begin{enumerate}
  ...
  \item #writeBlock(i,b)#: Zapiši vsebino bloka #b# v blok z indeksom #i#.

  \item #placeBlock(b)#: Vrni nov indeks in shrani vsebino bloka #b# na ta indeks.

  \item #freeBlock(i)#: Sprosti blok z indeksom #i#. To kaže, da vsebina tega bloka ni več v uporabi in da se zunanji pomnilnik, ki je bil dodeljen temu bloku, lahko ponovno uporabi.
\end{enumerate}

#BlockStore# si najlažje predstavljamo tako, da si ga zamislimo kot shranjevanje datoteke na disk, kateri je razdeljen na bloke, kjer vsak vsebuje $B$ bajtov. Na ta način #readBlock(i)# in #writeBlock(i,b)# preprosto bereta in zapisujeta bajte $#i#B,\ldots,(#i#+1)B-1$ te datoteke. Poleg tega bi preprost #BlockStore# lahko vodil \emph{prosti seznam} blokov, ki so na voljo za uporabo. Bloki, sproščeni s #freeBlock(i)#, so dodani prostemu seznamu. Na ta način lahko #placeBlock(b)# uporabi blok iz prostega seznama ali, če nobeden ni na voljo, doda nov blok na konec datoteke.
...
ki so opisana v \secref{dvaštiri}. (2-4 drevo je posebni primer $B$-drevesa,
...
\begin{align*}
    h & \le \frac{\log \ell-1}{\log B} + 1  \\
      ...
      & = \log_B \ell + 1 \enspace .
\end{align*}
Višina $B$-drevesa je sorazmerna logaritmu z osnovo, ki je enaka številu listov in 
stopnjo $B$.

Vsako vozlišče, #u#, v $B$-drevesu shranjuje polje ključev
$#u.ključi#[0],\ldots,#u.kluči#[2B-1]$.  Če je #u# notranje vozlišče z $k$
otroci, potem je število ključev, ki so shranjeni v #u# natanko $k-1$ in ti so
shranjeni v $#u.ključi#[0],\ldots,#u.keys#[k-2]$.  Ostalih $2B-k+1$
mest v polju #u.ključi# je nastavljeno na #null#.  Če je #u# notranje vozlišče
...
\[
   #u.ključi[0]# < #u.ključi[1]# < \cdots < #u.ključi#[k-2] \enspace .
\]
Če je #u# notranje vozlišče, potem za vsak $#i#\in\{0,\ldots,k-2\}$ velja, da
$#u.ključi[i]#$ je večji od vseh ključev shranjenih v poddrevesu zakoreninjenega na
...
v #u.ključi#. Če je, je bil #x# najden in iskanje je zaključeno.
V nasprotnem primeru, najdemo najmanjše število #i#, da je
$#u.ključi[i]# > #x#$ in nadaljujemo iskanje v poddrevesu zakoreninjenem na
#u.otrici[i]#. Če noben ključ v #u.ključi# ni večji od #x#, potem iskanje
