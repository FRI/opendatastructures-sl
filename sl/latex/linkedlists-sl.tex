...
Enostransko povezani seznam lahko implementira tudi operaciji  FIFO ("prvi noter, prvi ven") vrste, to sta  #add(x)# in #remove()#. Operacija brsianja elementa je identična operaciji #pop()#, odstrani se torej začetno vozlišče. Obe operaciji se izvedeta v konstantnem času.
