...
Vsaka izmed funkcij #find(x)#, #add(x)# ter #remove(x)# v strukturi #binarnega iskalnega drevesa# vključuje sledenje neki poti od korena drevesa pa do nekega vozlišča v drevesu. Brez dodatnega znanja o obliki drevesa je težko karkoli povedati o dolžini te poti, razen tega, da je pot manjša kot #n# - število vseh vozlišč v drevesu. Sledeči izrek povzame zmožnosti podatkovne strukture - #BinarySearchTree#:
