...
\begin{exc}
  ...
  samostojna števka, ki predstavlja kje v besedilu se pripona začne.

  \noindent Preizkusite svojo aplikacijo na veleikih besedilih, kot so na primer
  knjige dostopne na Project Gutenberg \cite{gutenberg}.  Če ste opravili
  pravilno, bodo vaše aplikacije zelo odzivne; Tako ne bi smelo biti
  nobenega znatnega zamika med pisanjem nizov in prikazovanjem rezultata.
\end{exc}
