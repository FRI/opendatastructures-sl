...
\section{Urejanje s štetjem in korensko urejanje (Counting Sort and Radix Sort)}
...
in to shrani v #c[i]#. Po urejanju izhodni produkt zgleda
...
\subsection{Korensko urejenje (Radix-Sort)}
...
#w#/#d#\rceil$.} Natančneje, korensko urejanje prvo uredi števila po
...
Ta neverjetni algoritem ureja pravilno, ker je urejanje s štetjem stabilen
...
nasledno različico izreka \thmref{radix-sort}.
