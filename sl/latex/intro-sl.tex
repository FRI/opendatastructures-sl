...
V tabeli~\ref{tab:summary-i} and \ref{tab:summary-ii} so povzete učinkovitosti podatkovnih struktur zajetih v tej knjigi, ki implementirajo vsakega od vmesnikov #List#, #USet#, and #SSet#, opisanih v \secref{interfaces}.
