...
To poglavje predstavlja eno najbolj temeljnih struktur v računalništvu: dvojiška drevesa. Uporaba besede \emph{drevo}
\index{tree}%
\index{tree!binary}%
\index{binary tree}%
prihaja iz dejstva, da ko jih rišemo, je risba podobna drevesom iz gozda.
...
navzdol. Koren je  na vrhu slike, ki ima levega in desnega otroka.
Levi otrok je na levi strani, desni pa na desni strani
...
Ker so dvojiška drevesa tako pomembna, so za njih razvili določeno terminologijo:
 \emph{globina}
\index{depth}%
vozliščea, #u#, je v binarnem drevesu
...
vozlišče kot svojega levega otroka in ustrezno vsako vozlišče, ki
...
\figref{bintree-traverse}.  Če pridemo do vozlišča #u# od #u.stars#,
potem obiščemo #u.levo#. Če pridemo do #u#
od #u.levo#, potem obiščemo #u.desno#. Če prispemo
 na #u# iz #u.desno# , potem smo končali z obiskovanjem #u# -jevih poddreves,
in se tako vrnemo na #u.stars#. Naslednja koda izvaja to
idejo, ki vključuje ravnanje v primerih, ko katera koli od #u.levo#,
#u.desno# ali #u.stars# je #nil#:
...
V nekaterih implementacijah binarnih dreves, se #stars# ne uporablja.
...
Na vsakem koraku, vzamemo naslednje vozlišče #u# iz #q# , nato procesiramo #u#, in dodamo #u.levo#
in #u.desno# (če niso #nil#) v #q#:
...
\section{#Binarno Iskalno Drevo#: Neuravnoteženo binarno iskalno drevo}
\seclabel{binarysearchtree}

\index{BinarySearchTree@#BinarySearchTree#}%
\index{binary search tree}%
\index{binary tree!search}%
#Binarno Iskalno Drevo# je posebna oblika binarnega drevesa, pri katerem vsako vozlišče #u# hrani tudi podatek #u.x# iz nekega skupnega vrstnega reda. Podatki binarnega iskalnega drevesa upoštevajo \emph{lastnost binarnih iskalnih dreves}:
\index{binary search tree property}%
Za vozlišče #u# velja, da vsak podatek shranjen v poddrevesu #u.levo# je manjši od #u.x# ter vsak podatek shranjen v poddrevesu #u.desno# je večji od #u.x#.  Primer #Binarnega Iskalnega Drevesa# je prikazan v \figref{bst}.
...
\begin{enumerate}
\item Če $#x#< #u.x#$, nadaljujemo z iskanjem v #u.levo#;
\item Če $#x#> #u.x#$, nadaljujemo z iskanjem v #u.desno#;
\item Če $#x#= #u.x#$, pomeni, da smo našli vozlišče #u#, ki hrani #x#.
\end{enumerate}
...
Primer je prikazan v \figref{bst-insert}. Najbolj časovno požrešen del tega procesa je začetno iskanje #x#-a, ki porabi količino časa, ki je sorazmerna z višino novo vstavljenega vozlišča #u#. V najslabšem primeru je ta enaka višini #Binarnega Iskalnega Drevesa#.
...
Brisanje vrednosti, ki jo hrani vozlišče #Binarnega Iskalnega Drevesa# #u#, je malce težjet.  Če je #u# list, potem preprosto odstranimo #u# od njegova starša.  Še bolje: Če ima #u# samo enega otroka, potem lahko odstranimo #u# iz drevesa tako, da #u.stars# posvoji #u#-jevega otroka(glej
\figref{bst-splice}):
...
Vsaka izmed funkcij #najdi(x)#, #vstavi(x)# ter #odstrani(x)# v #Binarnem Iskalnem Drevesu# vključujejo sledenje neki poti od korena drevesa pa do nekega vozlišča v drevesu. Brez dodatnega znanja o obliki drevesa je težko karkoli povedati o dolžini te poti, razen tega, da je manj kot #n# - število vseh vozlišč v drevesu. Sledeči (nič kaj poseben) izrek povzame zmožnosti podatkovne strukture - #Binarno Iskalno Drevo#:

\begin{thm}\thmlabel{bst}
  #Binarno Iskalno Drevo# implementira #SSet# vmesnik ter podpira funkcije #vstavi(x)#, #odstrani(x)# ter #najdi(x)# in $O(#n#)$ časa na operacijo.
\end{thm}

\thmref{bst} se slabo primerja z \thmref{skiplist}, ki prikazuje, da #PreskocniSeznamSSet# struktura lahko implementira #SSet# vmesnik z pričakovanim časom $O(\log #n#)$ na operacijo.  Problem #Binarnega Iskalnega Drevesa# tiči v tem, da lahko postane \emph{neuravnoteženo}. Namesto da drevo izgleda kot na \figref{bst}, lahko izgleda kot dolga veriga z #n# vozlišči, ki imajo po točno enega otroka, razen zadnjega,ki nima nobenega.
