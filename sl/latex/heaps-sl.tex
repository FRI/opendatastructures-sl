...
če je vozlišče #h1# oz. #h2# #nil#, združujemo s prazno množico in vrnemo vozlišče #h1# ali #h2#,
...
vrednost #h1.x#, potem lahko #h2# lahko rekurzivno združimo z #h1.left# ali #h1.right#, odvisno od
...
S pomočjo operacije #merge(h1,h2)# je vstavljanje #add(x)# enostavno. Ustvarimo novo vozlišče #u# z vrednostjo #x# in združimo vozlišče s korenom kopice:
