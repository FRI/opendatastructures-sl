...
{\bf Vaja 6.7.} Ustvarite podrazred BinaryTree, čigar vozlišča imajo polja za shranjevanje števil premega, obratnega in vmesnega pregleda.
...
{\bf Vaja 6.8.} Napišite nerekurzivno metode $nextPreOrder(#u#)$, $nextInOrder(#u#)$ in $nextPostOrder(#u#)$, ki vračajo vozlišče katero sledi $#u#$ v premem, vmesnem in obratnem pregledu. Te metode bi morale vzeti amortiziran konstanten čas.
...
{\bf Vaja 6.9.} Recimo, da imamo binarno drevo s pre-, in- in post-order številkami dodeljenimi vozliščem.
