...
vsem $B+1$ otrokom, ki so posvojeni vozlišču #w# popraviti kazalce na
...
\begin{exc}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
       \item #u# lahko posodi nekaj svojih ključev #v#; ali
       \item #u# se lahko razdeli in ključi #u# in #v# se lahko enakomerno razdelijo 
       med #u#, #v# in novonastalo vozlišče #w#.
    \end{enumerate}
    Pokažite, da se, da to vedno narediti na način, tako, da imajo po operaciji vsa 
    udeležena vozlišča (največ 3) vsaj  $B+\alpha B$ ključev in kvečjemu $2B-\alpha B$ 
    ključev, za neko konstanto  $\alpha > 0$.
    \item Naj bo #u# vozlišče s premalo ključi in naj bosta #v# ter #w# brata vozlišča #u#.
    Obstajata dva načina kako popraviti podkoračitev pri #u#:
    \begin{enumerate}
    ...
    \item Pokažite, da je temi spremembami, število združevanj, izposojanj in delitev, 
    ki se zgodijo med $m$ operacijami enako $O(m/B)$.
  \end{enumerate}
\end{exc}
