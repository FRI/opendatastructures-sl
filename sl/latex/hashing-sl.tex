...
\begin{thm}\thmlabel{hashtable}
  #Verizena razprsena tabela# uporablja vmesnik #USet#. V kolikor ignoriramo ceno
  klicev na #grow()#, #verizena razprsena tabela# izvaja operacije #add(x)#,
  #remove(x)#, in #find(x)# v $O(1)$ pričakovanem času na operacijo.

  Če začnemo s prazno #verizeno razprseno tabelo#, bo kakršnokoli zaporedje
