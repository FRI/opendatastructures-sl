...
#w#/#d#\rceil$.} Natančneje, korensko urejanje prvo uredi števila po najmanj pomembnih #d#
bitih nato po naslednjih #d#
...
(V tej kodi, izraz #(a[i] >> d*p)&((1<<d)-1)# izloči število katerega dvojiška
predstavitev je dana z biti
$(#p#+1)#d#-1,\ldots,#p##d#$ od #a[i]#.)
Primer korakov tega algoritma je prikazan na sliki \figref{radixsort}.
...
\begin{figure}
  ...
  \end{center}
  \caption{Uporaba korenskega urejanja za urejanje $#w#=8$-bitnega števila z uporabo 
   štirih prehodov z uporabo urejanja s štetjem na $#d#=2$-bitnih številih}
  \figlabel{korensko urejanje}
\end{figure}

\begin{thm}\thmlabel{korensko urejanje}
...
dobimo nasledno različico izreka \thmref{korensko urejanje}.
