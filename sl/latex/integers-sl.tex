...
Prva #find(x)# operacija (nad #xft#) vzame $O(\log#w#)$ časa.
Druga #find(x)# operacija (treaps) vzame $O(\log r)$ časa, kjer je
$r$ velikost treaps.  Kasneje v tem razdelku, bomo pokazali,da
je pričakovana velikost treaps $O(#w#)$ torej ta operacija vzame
...
časa.#Add(x)# metoda pokliče#xft.find(x)# ta treaps,
...
#xft#,mora biti treaps #t# razdeljeno na dva treaps, #t1# in #t'#.
Treaps #t1# vsebuje vse vrednosti manjše ali enake od #x#;
#t'# je prvotni treaps, #t#, z vsemi odstranjenimi elementi #t1#.
...
za #xft.find(x)#.  Iz #u#, dobimo treaps, #t#, ki vsebuje #x#
in ta #x# odstrani iz #t#.  Če je bil #x# shranjen v #xft# (in #x#
ni enak $2^{#w#}-1$) potem odstranimo #x# iz #xft# in dodamo 
elemente iz #x#-tega treaps v naključni treaps, #t2#, ki je shranjen v #u#-tem
