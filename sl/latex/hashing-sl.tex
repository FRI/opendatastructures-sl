...
\seclabel{hashtable}
Podatkovna struktura verižena razpršena tabela za shranjevanje tabele t seznamov uporablja zgoščevanje z veriženjem. Za hranjenje skupnega števila podatkov v vseh seznamih se uporablja celo število n.
...
\emph{Razpršena vrednost} podatkovnega elementa #x#, označena z #hash(x)# predstavlja vrednost v razponu $\{0,\ldots,#t.length#-1\}$. Vsi podatki z razpršeno vrednostjo #i#
