...
\newtheorem{cor}{Posledica}[chapter]
\newcommand{\corlabel}[1]{\label{cor:#1}}
\newcommand{\corref}[1]{\ref{cor:#1}}

\theoremstyle{definition}

\newtheorem{exc}{Naloga}[chapter]
\newcommand{\exclabel}[1]{\label{exc:#1}}
\newcommand{\excref}[1]{\ref{exc:#1}}


\newtheorem{prp}{Lastnost}[chapter]
\newcommand{\prplabel}[1]{\label{prp:#1}}
\newcommand{\prpref}[1]{\ref{prp:#1}}

% Miscellaneous commands
\newcommand{\etal}{\emph{et al.}}
\newcommand{\voronoi}{Voron\u\i}
...
% Title page content
\title{Open Data Structures (za programski jezik \lang)\textsuperscript{v slovenščini}}
\author{Pat Morin}
\date{%Development Edition: \today\ \currenttime
Izdaja 0.1F\cpponly{$\beta$}
...
\cpponly{
  \include{cpp-preface-sl}
  \cleardoublepage
}

\fancyhead[CE]{\small\nouppercase{\leftmark}} % chapter title, left center
\include{intro-sl-lang}
\include{arrays-sl-lang}
\include{linkedlists-sl-lang}
\include{skiplists-sl-lang}
\include{hashing-sl-lang}
\include{binarytrees-sl-lang}
\include{rbs-sl-lang}
\include{scapegoat-sl-lang}
\include{redblack-sl-lang}
\include{heaps-sl-lang}
\include{sorting-sl-lang}
\include{graphs-sl-lang}
\include{integers-sl-lang}
\include{btree-sl-lang}
