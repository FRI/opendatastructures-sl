...
#SMnožica# podpira #size()#, #add(x)#, in #remove(x)# metode z točno enako semantiko kot #UMnožica#  vmesnik. Razlika med #UMnožico# in #SMnožico# v metodi #find(x)#:
...
Na drugi strani, implementacija #UMnožice# kot #ChainedHashTable# v \chapref{hashing} ima #find(x)# operacijo ki potrebuje konstanten pričakovani čas. Ko izbiramo katero od teh struktur bomo uporabili, bi vedno morali uporabiti #UMnožico#, razen če je dodatna funkcionalnost ki jo ponudi #SMnožica# nujna.
