...
$P_0,\ldots,P_{r-1}$ čigar razpršilne kode so $#x#_0,\ldots,#x#_{r-1}$.
...
ga pomanjša v #w#-bitni končni rezultat. Tukaj je primer te metode uporabljene na enostavnemu sestavljenemu objektu s tremi deli #x0#, #x1#, and #x2#:
