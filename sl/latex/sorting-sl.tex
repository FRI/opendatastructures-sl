...
V tem poglavju se bomo pogovarjali o algoritmih, ki uredijo zbirko #n# elementov. To se lahko sliši kot čudna tema v knjigi podatkovnih struktur, ampak za to obstaja nekaj dobrih razlogov. Najočitnejši je ta, da sta dva od urejevalnih algoritmov(hitro urejanje in urejanje s kopico) tesno povezana s
