...
\begin{figure}
  ...
  \end{center}
  \caption[Dodajanje in odstranjevanje iz ArrayQueue]{Zaporedje operacin #add(x)# in #remove(i)# nad #ArrayQueue#. Puščice označujejo kopiranje elementov. Operacije, ki se zaključijo s klicem #resize()# so označene z zvezdico.}
  \figlabel{arrayqueue}
\end{figure}
