...
$\E[k]\le#w#-1$, ker je to isto metanje kovanca glede na prejšni odstavek, vendar v tem zadjni met ni bil štet.
...
\lemref{yfast-subtreesize} Je zadnji del v dokazu sledečega teorema, ki povzema učinkovitost #YFastTrie#:
...
Clen #w# v porabi prostora prihaja iz dejstva, da #xft# vedno hrani vrednost $2^#w#-1$. Implementacija je lahko drugačna (v zakup moramo vzeti dodajanje kode) in ni potrebno hraniti te vrednosti. V tem primeri prostorska zahtevnost teorema postane $O(#n#)$.
