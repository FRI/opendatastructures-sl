...
Collections Frameworku. \javaonly{Priložena izvirna koda vsebuje 
wrapper razrede za izdelavo #USet# in #SSet# implementacij v #Set#, #Map#, #SortedSet#
in #SortedMap# implementacije.}

Za detajlno obravnavo in razumevanje matematične vsebine tega poglavja,
ki vsebuje asimptotično notacijo, logaritme, factorials, 
Stirlingovo aproksimacijo, osnove verjetnosti in veliko drugega, vzemi v 
roko učbenik Lymana, Leightona in Meyerja \cite{llm11}. Za osnove kalkulusa, 
...
Več o osnovah verjetnosti, predvsem področja, ki je v tesni povezavi z računalništvom, 
...
\javaonly{Bralci, ki želijo še posebej izpiliti znanje programiranja v Javi, 
lahko najdejo primere vaj na spletu \cite{oracle_tutorials}.}

\begin{exc}
	Naloga je sestavljena tako, da bralca seznani s pravilnim 
	izbiranjem prave podatkovne strukture za dani primer. Če je del naloge 
	...
	strukturo/e. Implementacija mora biti dovolj hitra programa 
	mora biti dovolj hitra, da obdela datoteko z milijon vnosi v nekaj 
	sekundah. 

  \begin{enumerate}

  \item Preberi vhod vrstico za vrstico in za tem izpiši vrstice
	...
	\item Beri vhod vrstico po vrstico. Program bere po 42 vrstic in če
		je kater od teh prazna (npr. niz dolžine nič), potem izpiše 42.
		vrstico pred to, ki je prazna. Na primer, če je 242. vrstica prazna,
	...
	\item Beri vhod vrstico po vrstico in izpiši vse vrstice, ki so se
		vsaj enkrat že pojavile na vhodu (cilj tega je, da se izločijo
